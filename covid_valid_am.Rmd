...
```
для каждого ищем худший балл за время госпитализации, смотрим сколько из умерших и выживших хоть раз его перевалили
```{r}
length(unique(score_9$id))
table(data_full$DaysBfOutcome)
str(data)

t <- as.data.frame(is.na(score_9[,6:15]))
